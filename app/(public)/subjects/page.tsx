      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        ...
        <div className="max-w-md mx-auto relative pt-2">
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3.5 pl-11 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand shadow-sm"
          />
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-50 text-brand font-bold shadow-xs">
                ...
                <span className="text-[11px] font-bold text-brand uppercase tracking-wider block mt-0.5">
                  {sub.category}
                </span>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                ...
                <Link href={`/find-tutors?subject=${sub.slug}`} className="text-xs font-semibold text-brand hover:underline flex items-center gap-1">
