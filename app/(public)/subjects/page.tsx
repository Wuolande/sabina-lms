      ...
      <div className="text-center max-w-3xl mx-auto space-y-4 w-full min-w-0">
        ...
        <div className="max-w-md mx-auto relative pt-2">
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 pl-11 text-base sm:text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-brand shadow-sm min-h-[44px]"
          />
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl sm:rounded-2xl bg-brand-50 text-brand font-bold shadow-xs">
              ...
              <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-slate-100 flex items-center justify-between">
                <Link href={`/find-tutors?subject=${sub.slug}`}>
                  <Button variant="default" size="sm" className="font-bold text-xs bg-brand hover:brightness-90 text-white rounded-xl h-10 min-h-[40px]">
                    Find Tutors
                  </Button>
                </Link>
                <Link href={`/find-tutors?subject=${sub.slug}`} className="text-xs font-semibold text-brand hover:underline flex items-center gap-1 min-h-[40px]">
                  <span>Browse</span>
