...
export function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-slate-950 border-r border-slate-800 text-slate-300 transition-transform duration-300 ease-out lg:static lg:z-auto lg:translate-x-0",
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-slate-800">
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs font-semibold text-slate-500 hover:text-red-400 transition-colors cursor-pointer"
          >
